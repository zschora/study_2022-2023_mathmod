...
Округление:
- round(x)	округление к ближайшему целому числу typeof(x)
- round(T, x) округление к ближайшему целому числу
- floor(x)	округление x к -In
- floor(T, x)	округление x к -Inf
- ceil(x)	округление x к +Inf
- ceil(T, x)	округление x к +Inf
- trunc(x)	округление x по направлению к нулю
- trunc(T, x)	округление x по направлению к нулю
